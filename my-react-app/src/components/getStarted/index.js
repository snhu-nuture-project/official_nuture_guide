      ...
      <section className="get-started" id="get-started">
        <div className="row">
          <div className="col-md-6">
            <Zoom>
              <h1 className="name ">Setting up your PC </h1>
            </Zoom>
            <br />
            <p>
        ...
        <div className="row">
          <Fade delay={1000} left>
            <div className="col-md-6 border p-5">
              ...
              <hr className="hrt"></hr>
              <p>
                Login inoformation will be emailed to your personal email
                address that you provided to SNHU Human Resources on the Friday
                before your scheduled hire date. Login with your SNHU provided
                email and password.{" "}
                <span className="red-text">
                  ***Please DO NOT change your password. IT will walk you
                  through a password reset on day 1 to avoid complications ***
                </span>
              </p>
            </div>
          </Fade>
            ...
            <div className="col-md-6 border p-5">
              ...
              <ol>
                <li>
                  ...
                  instructions. <br></br>
                  a. Microsfot Authenticator App - download App onto mobile
                  device and click Next <br></br>
                ...
                <li>
                  {" "}
                  After successful setup of MFA, be sure to check "Don't Remind
                  me for 1 day" when logging in each time.
                </li>
              </ol>
            </div>
          </Fade>
          ...
          <Fade delay={1000} left>
            <div className="col-md-6 border p-5">
              <h2>
                <span className="primary">03 </span> Accessing Your Outlook
                Email{" "}
              </h2>
              <hr className="hrt"></hr>
              <ol>
                ...
                <li>
                  ...
                  a. If you have not setup MFA yet, yuo will be prompted to do
                  so.
                </li>
          ...
          <Fade delay={1500} right>
            <div className="col-md-6 border p-5">
              <h2>
                <span className="primary">04 </span> Connecting to the VPN{" "}
              </h2>
              <hr className="hrt"></hr>
              <p>
                You will need to be connected to the VPN to remorely change your
                password, access certain webpages, etc.
              </p>

              <ol>
                <li>
                  Run the Cisco AnyConnect Secure Mobility client by clickin g
                  on the icon. The icon maybe located on your bottom taskbar or
                  desktop.
                </li>

                <li>
                  {" "}
                  On the Cisco AnyConnect client that pops up, click connect.
                </li>
                <li>
                  VPN will say "Connected to remote.snhu.edu" when successful
                </li>
              </ol>
            </div>
          </Fade>
